...
public class DingMsgSendUtilTest {
    ...
    public void sendDingMsg() {
        ...
        sb.append("编号：").append("2435325").append("\n");
        sb.append("姓名：").append("而我二").append("\n");
        sb.append("电话：").append("65324324").append("\n");
        sb.append("微信：").append("wecaht").append("\n");
        sb.append("渠道：").append("微博").append("\n");
        sb.append("来源：").append("微博1").append("\n");
        sb.append("客服：").append("叶").append("\n");
        sb.append("成交套系： ¥").append("59999").append("\n");
