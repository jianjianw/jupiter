...
public class ClientExportVO implements Serializable {
     ...
     * 客资微信
     */
    @Excel(name = "微信号", width = 40)
    private String kzWechat;
    /**
     * 客资QQ
     */
    @Excel(name = "QQ", width = 40)
    private String kzQq;
    /**
     * 客资旺旺
     */
    @Excel(name = "旺旺", width = 40)
    private String kzWw;

    /**
     * 拍摄地名称
     */
    @Excel(name = "拍摄地", width = 30)
    private String shopName;
    /**
     * 邀约客服姓名
     */
    @Excel(name = "客服", width = 30)
     ...
     * 推广备注
     */
    @Excel(name = "鼠标手备注", width = 50)
    private String remark;
    /**
     * 省份地址
     */
    @Excel(name = "省份", width = 40)
    private String address;
    /**
     * 关键词
     */
    @Excel(name = "关键字", width = 40)
    private String keyWord;
    /**
     * 无效原因
     */
    @Excel(name = "无效原因", width = 60)
    private String invalidLabel;
    /**
     * 销售备注
     */
    @Excel(name = "销售备注", width = 100)
    private String memo;
