...
public class LoginController extends BaseController {
	...
	public ResultInfo loginWithCompanyIdByPhone(@RequestBody @Validated LoginUserVO loginUserVO) {
		...
		try {
			// 返回结果
			StaffPO staffPO = loginService.loginWithCompanyIdByPhone(userName, password, loginUserVO.getCompanyId(),
					getIp());
	...
	public ResultInfo checkToken(HttpServletRequest request) {
		...
		StaffPO staff = staffService.getByIdWithoutCache(requestToken.getUid(), requestToken.getCid());
		// 校验用户信息
