...
public class ChannelController extends BaseController {
    ...
    @GetMapping("/get_all_source")
    public ResultInfo getAllSource(@NotEmptyStr String ids) {
        //获取当前登录用户
        StaffPO currentLoginStaff = getCurrentLoginStaff();
        return ResultInfoUtil.success(channelService.getAllShowSource(currentLoginStaff.getCompanyId()));
    }
}