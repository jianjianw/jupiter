...
public class SchedulingServiceImpl implements SchedulingService {
    ...
    public List<GroupsInfoVO> getDeptListByType(String type, int companyId, int staffId) {
        ...
        } else if (roleList.contains(PmsConstant.SEE_MY_DEPT) || roleList.contains(PmsConstant.SEE_MYSELF) || roleList.contains(PmsConstant.SEE_MY_GROUP)) {  //查看部门
            for (GroupsInfoVO giv : list) {
    ...
    public List<GroupsInfoVO> getGroupListByDept(String deptId, int companyId, int staffId) {
        ...
        if (roleList.contains(PmsConstant.SEE_ALL) || roleList.contains(PmsConstant.SEE_MY_DEPT)) {    //查看所有  所有的都显示
