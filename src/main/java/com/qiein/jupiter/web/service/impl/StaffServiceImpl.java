...
import com.qiein.jupiter.web.dao.OnLineTimeDao;
...
import com.qiein.jupiter.web.entity.vo.StaffMsg;
...
public class StaffServiceImpl implements StaffService {
    ...
    public boolean heartBeat(StaffPO staffPO, String ip) {
        ...
        if (staffPO.getStatusFlag() == StaffStatusEnum.OnLine.getStatusId()) {
            ...
            int interval = onLineTimeDao.getLastHeartTime(staffPO.getId(), staffPO.getCompanyId(), DBSplitUtil.getOnLineTimeLogTabName(staffPO.getCompanyId()));
            if (interval > CommonConstant.DEFAULT_ONLINE_TIME) {
                onLineTimeDao.updateLastHeartTime(staffPO.getId(), staffPO.getCompanyId(), DBSplitUtil.getOnLineTimeLogTabName(staffPO.getCompanyId()));
            } else {
                onLineTimeDao.updateOnLineTime(staffPO.getId(), staffPO.getCompanyId(), DBSplitUtil.getOnLineTimeLogTabName(staffPO.getCompanyId()), interval);
            }
        }
