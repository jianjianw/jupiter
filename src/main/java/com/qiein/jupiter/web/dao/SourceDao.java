...
public interface SourceDao extends BaseDao<SourcePO> {
     ...
     * @return
     */
    List<SourcePO> findSourceByRole(@Param("companyId")Integer companyId,@Param("staffId")Integer staffId,@Param("sourceIds")String sourceIds);
     ...
     * @return
     */
    String getSourceNamesByIds(@Param("companyId") Integer companyId, @Param("ids") String[] ids);
}
