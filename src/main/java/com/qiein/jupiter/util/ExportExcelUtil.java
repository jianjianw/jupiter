...
public class ExportExcelUtil {
     ...
     * 导出文件流
     */
    public static void export(HttpServletResponse response, String fileName, List<?> list, Class<?> pojoClass) throws Exception {
        String fileNameTemp;
        fileNameTemp = URLEncoder.encode(fileName + ".xls", "UTF-8");
