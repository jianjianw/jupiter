...
public class TimeUtils {
	...
	public static SimpleDateFormat ymdSDFBias = new SimpleDateFormat("yyyy/MM/dd");
	...
	public static SimpleDateFormat CLIENT_SHOW_ALL = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	...
	public static String formatClientAllTime(String time) {
		...
		try {
			time = CLIENT_SHOW_ALL.format(yyyyMMddHHmmss.parse(time));
		} catch (Exception e) {
			time = "";
		}
	 ...
	 * @return
	 */
	public static String formatYyTime(String str, String strpattern, String pattern, String TimeZoneFormat) {
	...
	public static String getCurrentymdBias() {
		return ymdSDFBias.format(new Date());
	}
	 ...
	 * @return
	 */
	public static String getEarlyMonthDay() {
		Calendar c = Calendar.getInstance();
	 ...
	 * @return
	 */
	public static Long getTwoDayIntervalSecond(String endTime, String beginTime, boolean isEndTime) {
		if ((endTime == null || endTime.equals("") || (beginTime == null || beginTime.equals(""))))
			return 0L;
		long second = 0l;
		try {
			java.util.Date end = yyyyMMddHHmmss.parse(endTime);
			endTime = yyyyMMddHHmmss.format(end);
			java.util.Date start = yyyyMMddHHmmss.parse(beginTime);
			second = end.getTime() - start.getTime();
		} catch (Exception e) {
			return 0L;
		}
	 ...
	 * @return
	 */
	public static String getTwoDayIntervalDesc(String beginTime, boolean isEndTime) {
		Long second = getTwoDayIntervalSecond(getCurrentTime(), beginTime, isEndTime) / 1000;
		...
		if (second >= 29 * 24 * 60 * 60) {
			return "29天前";
		}
		if (second >= 28 * 24 * 60 * 60) {
			return "28天前";
		}
		if (second >= 27 * 24 * 60 * 60) {
			return "27天前";
		}
		if (second >= 26 * 24 * 60 * 60) {
			return "26天前";
		}
		if (second >= 25 * 24 * 60 * 60) {
			return "25天前";
		}
		if (second >= 24 * 24 * 60 * 60) {
			return "24天前";
		}
		if (second >= 23 * 24 * 60 * 60) {
			return "23天前";
		}
		if (second >= 22 * 24 * 60 * 60) {
			return "22天前";
		}
		if (second >= 21 * 24 * 60 * 60) {
			return "21天前";
		}
		if (second >= 20 * 24 * 60 * 60) {
			return "20天前";
		}
		if (second >= 19 * 24 * 60 * 60) {
			return "19天前";
		}
		if (second >= 18 * 24 * 60 * 60) {
			return "18天前";
		}
		if (second >= 17 * 24 * 60 * 60) {
			return "17天前";
		}
		if (second >= 16 * 24 * 60 * 60) {
			return "16天前";
		}
		if (second >= 15 * 24 * 60 * 60) {
			return "15天前";
		}
		if (second >= 14 * 24 * 60 * 60) {
			return "14天前";
		}
		if (second >= 13 * 24 * 60 * 60) {
			return "13天前";
		}
		if (second >= 12 * 24 * 60 * 60) {
			return "12天前";
		}
		if (second >= 11 * 24 * 60 * 60) {
			return "11天前";
		}
		if (second >= 10 * 24 * 60 * 60) {
			return "10天前";
		}
		if (second >= 9 * 24 * 60 * 60) {
			return "9天前";
		}
		if (second >= 8 * 24 * 60 * 60) {
			return "8天前";
		}
	...
	/*-- 指定时间加指定秒数 --*/
	public static long getDateBySecond(String s, int second) throws ParseException {
		Date date;
		try {
			date = CLIENT_SHOW.parse(s);
		} catch (ParseException e) {
